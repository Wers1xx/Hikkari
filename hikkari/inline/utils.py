...
class Utils(InlineUnit):
    ...
    def _needs_premium_emoji_pre_edit(self, text: typing.Any) -> bool:
        return self._has_premium_emoji(text) and bool(
            getattr(getattr(self._client, "hikkari_me", None), "premium", False)
        )
    ...
    def _generate_markup(
        self: "InlineManager",
        markup_obj: HikkariReplyMarkup | str | None,
    ...
    def _normalize_markup(
        self: "InlineManager", reply_markup: HikkariReplyMarkup
    ...
    def _validate_markup(
        self: "InlineManager",
        buttons: HikkariReplyMarkup | None,
    ) -> list[list[dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
